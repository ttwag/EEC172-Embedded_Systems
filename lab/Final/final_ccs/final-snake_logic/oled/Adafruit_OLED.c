...
*/
    ...
    // Set DC as Command by setting Pin 61 LOW
    GPIOPinWrite(GPIOA0_BASE, 0x40, 0);

    // Enable OLEDCS Pin 63
    GPIOPinWrite(GPIOA1_BASE, 0x1, 0);

    // SPI Transfer
    MAP_SPITransfer(GSPI_BASE, command, 0, 1, SPI_CS_ENABLE|SPI_CS_DISABLE);

    // Disable OLEDCS Pin 63
...
*/
    ...
    // Set DC as Data by setting Pin 61 HIGH
    ...
    // SPI Transfer
    MAP_SPITransfer(GSPI_BASE, data, 0, 1, SPI_CS_ENABLE|SPI_CS_DISABLE);
